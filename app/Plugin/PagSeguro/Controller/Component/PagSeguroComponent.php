...
$vendorDir = ROOT . DS . 'Vendor' . DS . 'PagSeguro';
...
App::import('PagSeguro', 'PagSeguroLibrary', array('file' => ROOT . DS . 'vendor' . DS . 'PagSeguro' . DS . 'PagSeguroLibrary' . DS . 'PagSeguroLibrary.php'));
...
require_once ROOT . '/vendor/PagSeguro/config/PagSeguroConfig.class.php';
require_once ROOT . '/vendor/PagSeguro/domain/PagSeguroAccountCredentials.class.php';
