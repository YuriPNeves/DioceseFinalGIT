...
<?php echo $this->Form->create('Comunidade'); ?>
	<fieldset>
		<legend><?php echo __('Edit Comunidade'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Comunidade.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Comunidade.id'))); ?></li>
